            ...
            <div className="space-y-2">
              <h4 className="font-bold text-slate-900 uppercase text-[11px] tracking-wide flex items-center justify-between">
                ...
                {primaryCitation.canonical_url && (
                  <a
                    href={primaryCitation.canonical_url}
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-indigo-600 hover:underline font-semibold lowercase"
                  >
              ...
              <div className="bg-amber-50/50 border border-amber-200/70 rounded-xl p-4 space-y-2">
                <div className="flex items-center justify-between font-semibold text-amber-950 text-xs">
                  <span>{String(primaryCitation.source_title || primaryCitation.authority || "Official Portal")}</span>
                  {primaryCitation.locator && (
                    <span className="text-[11px] bg-amber-100/70 px-2 py-0.5 rounded text-amber-800">
                      {String(primaryCitation.locator)}
                    </span>
                  )}
                </div>
